...
export default class EscPos extends Component {
  ...
  imprimirComanda = async () => {
    try {
      ...
      // await BluetoothEscposPrinter.setWidth(BluetoothEscposPrinter.width58);
      ...
      await BluetoothEscposPrinter.printText('Sistema XXXX\r\n', {
        encoding: 'CP_860',
        codepage: 0,
        widthtimes: 2,
        heigthtimes: 2,
      ...
      await BluetoothEscposPrinter.printText('Comanda de Consumo\r\n', {
        encoding: 'CP_860',
        codepage: 0,
        widthtimes: 1,
        heigthtimes: 0,
      ...
      await BluetoothEscposPrinter.setBlob(0);
      await BluetoothEscposPrinter.printText('Sem valor Fiscal\r\n', {
        encoding: 'CP_860',
        codepage: 0,
        widthtimes: 0,
        heigthtimes: 0,
      ...
      await BluetoothEscposPrinter.printText('Usuário: Rafael Santos\r\n', {
        encoding: 'CP_860',
      });
      await BluetoothEscposPrinter.printText('Terminal: Caixa\r\n', {
        encoding: 'CP_860',
      });
      await BluetoothEscposPrinter.printText(
        '--------------------------------\r\n',
      ...
      await BluetoothEscposPrinter.printColumn(
        ...
        ['Código', 'Descrição', 'Qtde', 'Valor Unit.'],
        {encoding: 'CP_860', widthtimes: 0, heigthtimes: 0, fonttype: 1},
      );
      await BluetoothEscposPrinter.printColumn(
        columnWidths,
        [
      ...
      await BluetoothEscposPrinter.printText('AGRADECEMOS A PREFERÊNCIA\r\n', {
        encoding: 'CP_860', fonttype: 1, heigthtimes: 1,
      });
      await BluetoothEscposPrinter.printerAlign(
        BluetoothEscposPrinter.ALIGN.LEFT,
      );
      ...
      <View style={{flex: 1}}>
          ...
          <Button
            onPress={async () => {
              ...
              await BluetoothEscposPrinter.printColumn(
                ...
                {encoding: 'CP_860', fonttype: 1},
              );
              await BluetoothEscposPrinter.printText('\r\n\r\n\r\n', {});
            }}
            title="Imprimir como coluna"
          />
        </View>
        <View style={styles.btn}>
          <Button
            disabled={this.state.loading || this.state.boundAddress.length <= 0}
            title="Imprimir auto teste"
            onPress={() => BluetoothEscposPrinter.selfTest(() => {})}
          />
        </View>
        <View style={styles.btn}>
          <Button
        ...
        <View style={styles.btn}>
          <Button
            disabled={this.state.loading || this.state.boundAddress.length <= 0}
            title="Efetuar Bip"
            onPress={() => BluetoothEscposPrinter.beep(2, 9)}
          />
        </View>
        <View style={styles.btn}>
          <Button
            disabled={this.state.loading || this.state.boundAddress.length <= 0}
            title="Imprimir as Imagens abaixo"
            onPress={async () => {
              try {
